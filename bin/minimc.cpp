...
int main(int argc, char* argv[]) {
  ...
  general.add_options()("config", boost::program_options::value<std::string>(), "Read configuration from config file")("task", boost::program_options::value<std::vector<std::string>>(), "Add task as entrypoint")("spacereduction", po::value<int>()->default_value(1)->notifier(updateSpace), "Space Reduction\n"
                                                                                                                                                                                                                                                                                                 "\t 1: None\n"
                                                                                                                                                                                                                                                                                                 "\t 2: Conservative\n")("simplifycfg", boost::program_options::bool_switch(&soptions.simplifyCFG), "Simplify the CFG structure")("constfold", boost::program_options::bool_switch(&soptions.foldConstants), "Constant Folding")("replacesub", boost::program_options::bool_switch(&soptions.replaceSub), "Replace sub instructions")("inlinefunctions", po::value<std::size_t>(&soptions.inlinefunctions), "Inline function calls")("unrollloops", po::value<std::size_t>(&soptions.unrollLoops), "Unroll Loops")("removeallocas", po::bool_switch(&soptions.removeAllocs), "Remove Alloca (replace them with equivalent construction)")("replacememnondet", po::bool_switch(&soptions.replacememnodet), "Remove Alloca (replace them with equivalent construction)")("removephi", po::bool_switch(&soptions.removephi), "Removephi")("cpa", po::value<int>()->default_value(0)->notifier(updateCPA), "CPA\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "\t 0: Automatic\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "\t 1: Location\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       "\t 2: Concrete\n"
#ifdef MINIMC_SYMBOLIC
  ...
  hidden.add_options()("command", po::value<std::string>(&subcommand), "Subcommand")("subargs", po::value<std::vector<std::string>>(), "Subcommand parameteers")("inputfile", po::value<std::string>(&input), "Input file");

  po::options_description desc;
  desc.add(general).add(hidden);

  po::positional_options_description pos;
  pos.add("inputfile", 1).add("command", 1).add("subargs", -1);

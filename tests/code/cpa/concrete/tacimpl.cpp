...
INSTANTIATE_TEST_CASE_P(
						...
						AddUi8,
						::testing::Values(
										  std::tuple<MiniMC::uint8_t,MiniMC::uint8_t,MiniMC::uint8_t>(4,2,6),
										  std::tuple<MiniMC::uint8_t,MiniMC::uint8_t,MiniMC::uint8_t>(10,2,12),
										  std::tuple<MiniMC::uint8_t,MiniMC::uint8_t,MiniMC::uint8_t>(255,2,255+2),
										  std::tuple<MiniMC::uint8_t,MiniMC::uint8_t,MiniMC::uint8_t>(0,2,2)

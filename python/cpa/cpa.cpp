...
void addCPAModule (py::module& m) {
  ...
  submodule
    ...
    .def ("Concrete",[]() {return MiniMC::CPA::CPA_ptr (new MiniMC::CPA::Compounds::CPA
							(std::initializer_list<MiniMC::CPA::CPA_ptr>({
							    std::make_shared<MiniMC::CPA::Location::CPA> (),
							    std::make_shared<MiniMC::CPA::Concrete::CPA> ()})));})

    .def ("Pathformula",[]() {return MiniMC::CPA::CPA_ptr (new MiniMC::CPA::Compounds::CPA
							(std::initializer_list<MiniMC::CPA::CPA_ptr>({
							    std::make_shared<MiniMC::CPA::Location::CPA> (),

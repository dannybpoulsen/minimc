...
void addModelModule(py::module& m) {
  ...
  py::class_<MiniMC::Model::VariableStackDescr, MiniMC::Model::VariableStackDescr_ptr>(submodule, "VariableStack")
      ...
      .def_property(
          "variables", [](const MiniMC::Model::VariableStackDescr_ptr& ptr) { return py::make_iterator(ptr->getVariables().begin(), ptr->getVariables().end()); },
          nullptr,
          py::keep_alive<0, 1>());
  ...
  py::class_<MiniMC::Model::Location, MiniMC::Model::Location_ptr>(submodule, "Location")
      ...
      .def(
          "edges", [](const MiniMC::Model::Location_ptr& ptr) { return py::make_iterator(ptr->ebegin(), ptr->eend()); },
          py::keep_alive<0, 1>())
  ...
  py::class_<MiniMC::Model::Edge, MiniMC::Model::Edge_ptr>(submodule, "Edge")
      .def_property(
          "from_loc", [](MiniMC::Model::Edge_ptr& ptr) { return ptr->getFrom().get(); }, nullptr)
      .def_property(
          "to_loc", [](MiniMC::Model::Edge_ptr& ptr) { return ptr->getTo().get(); }, &MiniMC::Model::Edge::setTo)
  ...
  py::class_<MiniMC::Model::CFG, MiniMC::Model::CFG_ptr>(submodule, "CFg")
      ...
      .def(
          "locations",
          [](const MiniMC::Model::CFG_ptr& ptr) { return py::make_iterator(ptr->getLocations().begin(), ptr->getLocations().end()); },
          py::keep_alive<0, 1>())
      .def(
          "edges",
          [](const MiniMC::Model::CFG_ptr& ptr) { return py::make_iterator(ptr->getEdges().begin(), ptr->getEdges().end()); },
          py::keep_alive<0, 1>());
  ...
  py::class_<MiniMC::Model::Function, MiniMC::Model::Function_ptr>(submodule, "Function")
      ...
      .def_property(
          "variable_stack", [](MiniMC::Model::Function_ptr& ptr) { return ptr->getVariableStackDescr(); }, nullptr)
      .def_property(
          "cfg",
          [](MiniMC::Model::Function_ptr& ptr) { return ptr->getCFG().get(); },
          nullptr)
  ...
  py::class_<MiniMC::Model::Program, MiniMC::Model::Program_ptr>(submodule, "Program")
      .def_property(
          "functions", [](const MiniMC::Model::Program_ptr& ptr) { return py::make_iterator(ptr->getFunctions().begin(), ptr->getFunctions().end()); },
          nullptr,
          py::keep_alive<0, 1>())
      ...
      .def(
          "getEntryPoints", [](const MiniMC::Model::Program_ptr& ptr) { return py::make_iterator(ptr->getEntryPoints().begin(), ptr->getEntryPoints().end()); }, py::keep_alive<0, 1>())
      .def("makeEntryPoint", [](MiniMC::Model::Program_ptr& program, MiniMC::Model::Function_ptr function) {
        return MiniMC::Model::createEntryPoint(program, function).get();
      })
      .def_property(
          "initialiser", [](const MiniMC::Model::Program_ptr& ptr) { return &ptr->getInitialisation(); }, nullptr, py::return_value_policy::reference);

  py::class_<MiniMC::Model::InstructionStream>(submodule, "InstructionStream")
      .def_property(
          "instructions", [](MiniMC::Model::InstructionStream* stream) { return py::make_iterator(stream->begin(), stream->end()); },
...
#undef X
  ...
  instruction
      ...
      .def_property(
          "ops", [](MiniMC::Model::Instruction* instr) { return py::make_iterator(instr->begin(), instr->end()); }, nullptr, py::keep_alive<0, 1>());
}
